...
func checkInside(assignment string) bool {
	...
	return ((firstElf1 <= secondElf1) && (secondElf1 <= firstElf2)) ||
		((firstElf1 <= secondElf2) && (secondElf2 <= firstElf2)) ||
		((secondElf1 <= firstElf1) && (firstElf1 <= secondElf2)) ||
		((secondElf1 <= firstElf2) && (firstElf2 <= secondElf2))
}
